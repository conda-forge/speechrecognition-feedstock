...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1944&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/speechrecognition-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `speechrecognition` can be installed with `conda`:
...
```
mamba install speechrecognition
```

It is possible to list all of the versions of `speechrecognition` available on your platform with `conda`:
...
```
mamba search speechrecognition --channel conda-forge
```
...
mamba repoquery search speechrecognition --channel conda-forge

# List packages depending on `speechrecognition`:
mamba repoquery whoneeds speechrecognition --channel conda-forge

# List dependencies of `speechrecognition`:
mamba repoquery depends speechrecognition --channel conda-forge
```
